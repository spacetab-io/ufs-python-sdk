...
class TestAPI(unittest.TestCase):
    ...
    def test_train_list(self):
        ...
        self.assertEquals(train_list.data.trains[0].cars[0].min_service_price, 270.0)
        self.assertEquals(train_list.data.trains[0].cars[0].max_price, 3934.0)
    ...
    def test_car_list_ex(self):
        ...
        self.assertEquals(car_list_ex.train.cars[0].car_info.car_arrival_time, None)
        self.assertEquals(car_list_ex.train.cars[0].car_info.car_passenger_arrival_time, None)
