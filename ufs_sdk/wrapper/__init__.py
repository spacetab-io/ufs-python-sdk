...
class TicketInfo(object):
    def __init__(self, json):
        ...
        # Ставка НДС с тарифа (в процентах)
        self.percent_tariff_nds = get_item(json.get('STV1'), int)
        # Ставка НДС с сервиса (в процентах)
        self.percent_service_nds = get_item(json.get('STV2'), int)
        # Ставка НДС с комиссионного сбора (в процентах)
        self.commission_nds = get_item(json.get('STV3'), int)
...
class BlankXml(object):
    def __init__(self, json):
        ...
        self.stv1 = get_item(json.get('STV1'), int)
        self.stv2 = get_item(json.get('STV2'), int)
        self.stv3 = get_item(json.get('STV3'), int)
...
class BlankTransInfo(object):
    def __init__(self, json):
        ...
        self.tariff_rate_nds = get_item(json.get('TariffRateNds'), int)
        self.service_rate_nds = get_item(json.get('ServiceRateNds'), int)
        self.fee_rate_nds_commission = get_item(json.get('CommissionFeeRateNds'), int)
        self.reclame_rate_nds = get_item(json.get('ReclamationCollectRateNds'), int)
        self.return_tariff_nds = get_item(json.get('TariffReturnNds'), int)
        self.return_service_nds = get_item(json.get('ServiceReturnNds'), int)
        self.return_fee_rate_nds_commission = get_item(json.get('CommissionFeeReturnNds'), int)
        self.return_reclame_rate_nds = get_item(json.get('ReclamationCollectReturnNds'), int)
        self.return_ticket_amount = get_money(json.get('TicketReturnAmount'))
        self.return_reservation_seat_amount = get_money(json.get('ReservedSeatReturnAmount'))
        self.return_service_amount = get_money(json.get('ServiceReturnAmount'))
        self.return_reclame_amount = get_money(json.get('ReclamationCollectReturnAmount'))
